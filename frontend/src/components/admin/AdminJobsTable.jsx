...
//       <Table className="min-w-[600px] w-full border border-gray-200 text-sm sm:text-base">
//         <TableCaption className="text-sm text-gray-500">
//           A list of your recent posted jobs
//         </TableCaption>
//         <TableHeader>
//           <TableRow>
//             <TableHead className="whitespace-nowrap px-4 py-3 text-left min-w-[150px]">
//               Company Name
//             </TableHead>
//             <TableHead className="whitespace-nowrap px-4 py-3 text-left min-w-[150px]">
//               Role
//             </TableHead>
//             <TableHead className="whitespace-nowrap px-4 py-3 text-left min-w-[120px]">
//               Date
//             </TableHead>
//             <TableHead className="whitespace-nowrap px-4 py-3 text-right min-w-[80px]">
//               Action
//             </TableHead>
//           </TableRow>
//         </TableHeader>
...
//             <TableRow key={job._id} className="even:bg-gray-50">
//               <TableCell
//                 className="whitespace-nowrap px-4 py-2 max-w-[180px] truncate"
...
import { Popover, PopoverContent, PopoverTrigger } from '../ui/popover';
import { Eye, MoreHorizontal } from 'lucide-react'; // removed Edit2 import
import { useSelector } from 'react-redux';
import { useNavigate } from 'react-router-dom';
