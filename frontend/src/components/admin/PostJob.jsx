...
const PostJob = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col pt-16 bg-gray-50">
      <Navbar />
      <div className="flex flex-grow items-center justify-center w-full px-4 py-6 sm:py-10 overflow-auto">
        <form
          onSubmit={submitHandler}
          className="p-6 max-w-4xl w-full sm:min-w-[400px] min-w-[320px] border border-gray-200 shadow-lg rounded-md bg-white"
        >
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              <Label>Title</Label>
