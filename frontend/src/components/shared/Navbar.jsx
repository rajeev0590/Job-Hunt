...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 w-full bg-[#153556] text-white shadow-md z-50">
      <div className="w-full px-4 sm:px-6 py-4 flex items-center justify-between max-w-screen-xl mx-auto">
        {/* Logo */}
        <h1 className="text-2xl font-bold whitespace-nowrap cursor-pointer select-none">
          Job<span className="text-[#F83002]">Hunt</span>
        </h1>
        ...
        <button
          ...
          className="md:hidden text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#F83002]"
        ...
        {/* Desktop Navigation */}
        <nav className="hidden md:flex items-center gap-6">
          <ul className="flex items-center gap-6 text-sm font-medium">{renderNavLinks()}</ul>
          ...
          {!user ? (
            <div className="flex items-center gap-4">
              <Link to="/login">
                <Button
                  variant="outline"
                  className="text-[#F83002] hover:bg-[#F83002] hover:text-white rounded-full px-4 py-2 transition"
                >
                  Login
                </Button>
              </Link>
              <Link to="/signup">
                <Button className="bg-[#F83002] text-white hover:bg-[#D6281D] rounded-full px-4 py-2 transition">
                  Signup
                </Button>
              </Link>
            </div>
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Avatar className="cursor-pointer" tabIndex={0} aria-label="User menu">
                  <AvatarImage
      ...
      {/* Mobile Menu */}
      {menuOpen && (
        <nav className="md:hidden bg-[#153556] px-4 pb-4 border-t border-[#F83002]">
          <ul className="flex flex-col gap-4 text-sm font-medium">{renderNavLinks()}</ul>
          <div className="mt-4 flex flex-col gap-2">
            {!user ? (
              <>
                <Link to="/login" onClick={handleLinkClick}>
                  <Button
                    variant="outline"
                    className="w-full text-[#F83002] hover:bg-[#F83002] hover:text-white rounded-full transition"
                  >
                    Login
                  </Button>
                </Link>
                <Link to="/signup" onClick={handleLinkClick}>
                  <Button className="w-full bg-[#F83002] text-white hover:bg-[#D6281D] rounded-full transition">
                    Signup
                  </Button>
                </Link>
              </>
              ...
              <Button
                ...
                className="w-full bg-[#F83002] hover:bg-[#D6281D] text-white rounded-full transition"
              >
                Logout
              </Button>
            )}
